...
json_query_t zakir_query5() {
    ...
    json_query_add_string_filter(query, "p80.http.get.headers.server",
                                 q5_p80_http_get_headers_server);
    return query;
}
...
json_query_t twitter_query1() {
    json_query_t query = json_query_new();
    json_query_add_string_filter(query, "text",
                                  q9_text);
    json_query_add_string_filter(query, "created_at",
                                  q9_created_at);
    return query;
}
